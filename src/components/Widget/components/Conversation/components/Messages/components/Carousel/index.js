            ...
            <div className="rw-carousel-card" key={index}>
              {carouselCard.data ?
                   <div className="rw-carousel-card-image">
                      {carouselCard.data.map((values) => {
                        console.log("========>", carouselCard.data)
                        console.log("values", values.name, values.value)
                        return (<div
                          className="rw-reply"
                        ...
                        >
                          <span>{values.name} : {values.value}</span>
                        </div>)
                      })}
                   </div>                
                   : ''}
